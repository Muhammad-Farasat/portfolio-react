            ...
            <div className='container mx-auto ' >
                ...
                <div className='flex justify-center mt-8 '>
                    <div className='text-center' >
                        <h2 className=' text-[32px] text-[#00FFFF] max-sm:text-[22px] max-lg:text-[26px] ' >About Me</h2>
                        <div className='w-48 h-[2px] bg-[#fff] flex justify-center items-center rounded-md max-sm:w-36 max-lg:w-36 ' >
                            <div className=' w-16 h-1 bg-[#00FFFF] rounded-md max-sm:w-10 max-lg:w-12 ' ></div>
                        </div>
                    </div>
                </div>
